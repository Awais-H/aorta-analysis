...
BLOB_INSCRIBED_RADIUS_MM = 8.0  # rule 4 blob_at_seed: the inscribed circle of the seed cross-section reaching 8 mm means the seed sits inside a bright region at least 16 mm across: no daughter lumen is that wide 5 mm from the aorta (celiac and SMA are under 9 mm; the iliacs are out of scope). Fires on an intervertebral disc contact at a 105 HU threshold (subject 22) and on the heart and arch contacts of subject 25, on no reference
